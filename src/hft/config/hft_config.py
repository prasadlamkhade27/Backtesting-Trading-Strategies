...
if __name__ == "__main__":
    ...
    # Example 1: Get a preset
    print("Example 1: Getting a preset")
    print("="*70)
    config = get_preset('MODERATE_SCALPING')
    print(f"Preset: {config.name}")
    print(f"Description: {config.description}")
    print(f"Risk per trade: {config.get('risk_percent_per_trade')}%")
    print(f"Max positions: {config.get('max_open_positions')}\n")
    
    # Example 2: List all presets
    print("Example 2: Available Presets")
    print("="*70)
    print(list_presets())
    
    # Example 3: Compare presets
    print("\nExample 3: Comparing Presets")
    print("="*70)
    ...
    # Example 4: Export a preset
    print("\nExample 4: Exporting Preset")
    print("="*70)
    import json
    config = get_preset('MODERATE_SCALPING')
